...
**Inventory status (2026-09-15): SIX deferred-defect pins**, each owned by an
...
`kumiko_wrap_lattice_cut_inmem.rs`), the fanned developable band
(`tessellate::tests::band_with_split_ruling_keeps_triangles_on_the_arc`)
and the flush slot bar (`fuse_a_rod_with_a_flush_slot_bar_crossing_its_rim`).
