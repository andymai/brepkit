...
| **The ball less a column 4.4 wide entering it from below falls back** (`make_sphere(3, 32)` less `make_box(4.4, 4.4, 10)` at `(-2.2, -2.2, -1)`, whose walls' circles do not meet on the sphere) | Undug. 545 planar faces, on main as well; the columns 0.2 to 3.6 wide are exact |
