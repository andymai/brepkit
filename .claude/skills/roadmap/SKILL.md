...
- **A ball less a box corner, and the box-sphere octant (CLOSED 2026-09-25; pins in `crates/operations/tests/sphere_box_corner.rs`)**:
  ...
  and a rod through it measured 12.824527 against 12.816012. A cap's
  (u, v)-box flux picked its pole from the boundary centroid, which sits on
  the axis; it reads the wire's turn in u now.
