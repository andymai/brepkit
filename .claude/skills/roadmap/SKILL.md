...
- **A rod or cone through a plate's edge fused short (CLOSED 2026-09-25; pins in `crates/operations/tests/rod_through_plate_edge.rs`)**:
  ...
  hole-aware path, and the refinement stops at the face's coarsest shared
  boundary edge, which it had halved toward until the face fell back to a
  mesher that cracked its boundary.
