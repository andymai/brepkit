...
/// `solid_volume` to 1e-9 and, for each cap perpendicular to z, `face_area`
/// to 1e-12 of one of `cap_areas`.
fn check(topo: &Topology, solid: SolidId, volume: f64, cap_areas: &[f64]) {
